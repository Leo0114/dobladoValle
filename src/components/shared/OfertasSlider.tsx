...
export default function OfertasSlider() {
  ...
  return (
    <div className="relative p-4 rounded-lg bg-secondary w-full overflow-hidden shadow-xl">
      ...
      >
        {ofertasData.map((oferta, index) => (
          <SwiperSlide key={oferta.id}>
            {/* Layout: contenido izq + imagen der — altura media */}
            <div className="flex h-[280px] items-stretch">
              {/* ── Contenido izquierdo ── */}
              <div className="flex flex-1 flex-col justify-center gap-3 px-8 py-6 md:px-12">
                {/* Badge */}
                <div>
                  <span
                    className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[0.6rem] font-bold uppercase tracking-[0.18em]"
                    style={{
                ...
                <div className="flex items-center gap-5">
                  ...
                  >
                    ${oferta.price}
                    <span
                      className="ml-1 text-xs font-normal opacity-60 text-white"
                  ...
                  <a
                    href="/contacto"
                    className="inline-flex items-center gap-2 rounded-full px-5 py-2 text-xs font-bold uppercase tracking-[0.1em] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
                    style={{
                      background: "var(--color-primary)",
                      color: "var(--color-ink)",
                      fontFamily: "var(--font-body)",
              ...
              {/* ── Imagen derecha ── */}
              <div className="flex shrink-0 items-center justify-center px-6 py-6 md:px-10">
                <div
                  className="overflow-hidden rounded-2xl border-[3px] bg-white shadow-xl transition-transform duration-500 hover:scale-105"
                  style={{
      ...
      {/* ── Controles debajo ── */}
      <div className="flex items-center justify-between px-8 pb-4 md:px-12">
