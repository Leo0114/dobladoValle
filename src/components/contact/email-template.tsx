...
//  Design tokens (Doblado Valle colors)
const BRAND = {
  primary: "#dea130",
  shade: "#c08a20",
  secondary: "#ca0119",
...
export function EmailTemplate({
  ...
  const replySubject = encodeURIComponent(`Re: ${asunto}`);
  ...
  return (
    <div style={s.wrapper}>
      <div style={s.card}>
        {/* ── Header ── */}
        <div style={s.header}>
          <div style={s.logoBadge}>Doblado Valle</div>
        ...
        <div style={s.body}>
          ...
          <div style={s.fieldBoxFull}>
            <span style={s.fieldLabel}>Asunto</span>
            <p style={s.fieldValue}>{asunto}</p>
          </div>

          {interesLabel && (
            <div style={{ ...s.fieldBoxFull, marginBottom: 24 }}>
              <span style={s.fieldLabel}>Categoría o Producto de interés</span>
        ...
        <div style={s.footer}>
          <p style={s.footerText}>
            ...
            contacto de <strong>dobladovalle.com</strong>. Por favor no respondas
            directamente a este mensaje.
          </p>
          <p style={{ ...s.footerText, marginTop: 8 }}>
            © {new Date().getFullYear()} Doblado Valle · Todos los derechos reservados
          </p>
        </div>
      </div>
    </div>
